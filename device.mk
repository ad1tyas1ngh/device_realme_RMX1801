...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/irq/msm_irqbalance_sdm630.conf:$(TARGET_COPY_OUT_VENDOR)/etc/msm_irqbalance_sdm630.conf
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/telephony_product_privapp-permissions-qti.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/telephony_product_privapp-permissions-qti.xml
